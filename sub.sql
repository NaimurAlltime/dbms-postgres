...
-- Retrieve all employees2 whose salary is greater than the highest salary of the HR department
-- 63000

SELECT salary from employees2 WHERE department_name = 'HR'; -- 63000

-- //! SELECT * from employees2 WHERE salary > 63000
